...
def list_folder(infolder):
    ...
    return [os.path.join(infolder, f) for f in os.listdir(infolder) if f.endswith(".avg")]

def extract_depth(source, depthdict):
    #name, length, coverage, averagedepth (number of reads covering a base/coverage)
